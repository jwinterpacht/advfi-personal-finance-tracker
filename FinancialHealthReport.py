...
class FinancialHealthReport(Report):
    ...
    def to_string(self) -> str:
        financial_health_report = f"Financial Health Report\n{self._report_date}\n---------------------------\nNet worth: ${self._net_worth}\n\nTotal asset value: ${self._total_assets}\nTotal debt value: ${self._total_liabilities}\nTotal income: ${self._total_income}\nTotal spending: ${self._total_expenses}\n\nSavings rate: {self._savings_rate:.2f}%\nInvestment return: {self._investment_return}%\n\nAdvFi Score: {self._advfi_score}\n"
